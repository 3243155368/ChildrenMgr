...
namespace ET.Server
{
    ...
    public static partial class UnitCacheComponentSystem
    {
        ...
        public static void CallCache(this ET.Server.UnitCacheComponent self, long id)
        {
        ...
        public static async ETTask<Entity> Get(this ET.Server.UnitCacheComponent self, long unitId, string key)
        {
            ...
            if (!self.UnitCaches.TryGetValue(key, out EntityRef<UnitCache> unitCacheEntityRef))
            {
